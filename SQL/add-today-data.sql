...
VALUES 
(1, 1, 1, 3, 'requested', 1, 1, '2025-06-25', GETDATE()),
(2, 2, 2, 4, 'requested', 2, 1, '2025-06-25', GETDATE()),
(3, 3, 3, 5, 'requested', 3, 1, '2025-06-25', GETDATE());
...
(1, @appointment1, 3, GETDATE(), 'requested'),
(1, @appointment1, 5, GETDATE(), 'requested'),

-- Appointment 2: 1 service  
(2, @appointment2, 4, GETDATE(), 'requested'),

-- Appointment 3: 1 service
(3, @appointment3, 5, GETDATE(), 'requested');
