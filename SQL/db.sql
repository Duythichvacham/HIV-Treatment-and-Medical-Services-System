...
CREATE TABLE ARVRegimens (
    ...
    name VARCHAR(100) UNIQUE NOT NULL,-- tên phác đồ
    for_group VARCHAR(50),-- ex: mẹ bầu, trẻ em
...
CREATE TABLE Rooms (
    ...
    room_name VARCHAR(50) NOT NULL,     -- ví dụ: "Phòng 201", "XN Máu"
    room_type VARCHAR(30) NOT NULL,     -- ví dụ: "Khám", "Xét nghiệm" -- này có thể không cần nhưng giữ lại có thể mở rộng
...
CREATE TABLE Services (
    ...
    service_type VARCHAR(30) NOT NULL CHECK (service_type IN ('test', 'examination', 'consultation')), -- cần mở rộng thì tách bảng vì nó 1-M
    description TEXT,
    price DECIMAL(10,2),
...
CREATE TABLE MedicalHistory (
    ...
    arv_adherence VARCHAR(20) CHECK (arv_adherence IN ('good', 'average', 'poor')),
