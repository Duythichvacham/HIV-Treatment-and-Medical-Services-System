...
(12, N'Phạm Thị Dung', '1995-01-30', 'female', 'ptd@email.com', '0904567890', N'321 Võ Văn Tần, Q.3, TP.HCM'),
...
(N'Phòng xét nghiệm', N'Xét nghiệm'),
(N'Phòng tư vấn', N'Tư vấn');
...
(N'Xét nghiệm khẳng định', 'test', N'Tầm soát viêm gan SSR', 80000, 6, 1),
...
(3, 3, 3, 2, 'in_progress', 1, 3, '2025-06-21'),
(4, 1, 4, 1, 'requested', 1, 1, '2025-06-23'),
(5, 2, 5, 1, 'requested', 1, 2, '2025-06-23');
...
(2, 2, 3, '2025-06-21 10:30:00', 7, '2025-06-21 11:00:00', 'in_progress'),
(2, 2, 5, '2025-06-21 10:30:00', 7, '2025-06-21 11:00:00', 'requested');

-- 12. TestNotes
INSERT INTO TestNotes (request_id, appointment_id, created_by_id, test_datetime) VALUES
(1, 1, 5, '2025-06-21 14:00:00'),
(2, 1, 5, '2025-06-21 14:30:00'),
(3, 2, 6, '2025-06-21 15:00:00');
...
-- 19. Invoices
INSERT INTO Invoices (patient_id, -- Dữ liệu mẫu cho cơ sở dữ liệu HIV_HEALTH_CARE (Đã chỉnh sửa và bổ sung)
...
('doctor02', 'hash_doctor2_password', 'Doctor', 'active'),
('doctor03', 'hash_doctor3_password', 'Doctor', 'active'),
('doctor04', 'hash_doctor4_password', 'Doctor', 'active'),
('doctor05', 'hash_doctor5_password', 'Doctor', 'active'),
('labstaff01', 'hash_lab1_password', 'Lab-Staff', 'active'),
('labstaff02', 'hash_lab2_password', 'Lab-Staff', 'active'),
('labstaff03', 'hash_lab3_password', 'Lab-Staff', 'active'),
('regstaff01', 'hash_reg1_password', 'Registration-staff', 'active'),
('regstaff02', 'hash_reg2_password', 'Registration-staff', 'active'),
('regstaff03', 'hash_reg3_password', 'Registration-staff', 'active'),
('patient01', 'hash_patient1_password', 'Patient', 'active'),
('patient02', 'hash_patient2_password', 'Patient', 'active'),
('patient03', 'hash_patient3_password', 'Patient', 'active'),
('patient04', 'hash_patient4_password', 'Patient', 'active'),
('patient05', 'hash_patient5_password', 'Patient', 'active'),
('patient06', 'hash_patient6_password', 'Patient', 'active'),
('patient07', 'hash_patient7_password', 'Patient', 'active'),
('patient08', 'hash_patient8_password', 'Patient', 'active'),
('patient09', 'hash_patient9_password', 'Patient', 'active'),
('patient10', 'hash_patient10_password', 'Patient', 'active');
