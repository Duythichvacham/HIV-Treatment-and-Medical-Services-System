...
(3, 3, 3, 2, 'completed', 1, 3, '2025-06-23'),
...
(1, 1, 4, '2025-06-23 09:30:00', 7, '2025-06-23 10:00:00', 'completed'),
(2, 2, 3, '2025-06-23 10:30:00', 7, '2025-06-23 11:00:00', 'completed'),
(3, 3, 5, '2025-06-23 11:30:00', 8, '2025-06-23 12:00:00', 'completed'),
(2, 2, 6, '2025-06-23 10:30:00', NULL, NULL, 'requested');
...
(5, N'AZT/3TC/LPV/r', '1 viên', N'1 lần/ngày', 30, N'Uống vào buổi sáng, sau ăn', N'Phác đồ cho trẻ em'),
...
(N'Hiểu về HIV và cách phòng tránh', N'HIV là virus gây suy giảm miễn dịch ở người...', 2, 1, 1),
(N'Tầm quan trọng của việc tuân thủ điều trị ARV', N'Việc uống thuốc ARV đúng giờ, đủ liều...', 3, 1, 1),
(N'Dinh dưỡng cho người nhiễm HIV', N'Chế độ dinh dưỡng hợp lý giúp tăng cường sức khỏe...', 4, 1, 1),
(N'Tin tức: Nghiên cứu mới về điều trị HIV', N'Các nhà khoa học vừa công bố kết quả nghiên cứu mới...', 1, 0, 1),
(N'Quản lý tác dụng phụ của thuốc ARV', N'Hướng dẫn cách nhận biết và xử lý các tác dụng phụ...', 5, 1, 1);
...
(2, 2, NULL, 150000, N'Khám bệnh', 'paid', '2025-06-23 10:00:00'),
(2, NULL, 3, 200000, N'Xét nghiệm CD4', 'paid', '2025-06-23 15:00:00'),
