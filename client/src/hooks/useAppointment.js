  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        room: res?.room_name || res?.appointment?.room_name || "Chưa xác định",
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        room: res?.room_name || res?.appointment?.room_name || "Online",
        doctorOrStaff: selectedDoctor.name,
        date: selectedDate,
        time: selectedTime.time_slot || selectedTime.time,
        fee: getConsultPrice(),
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        room: res?.room_name || res?.appointment?.room_name || "Phòng xét nghiệm A",
