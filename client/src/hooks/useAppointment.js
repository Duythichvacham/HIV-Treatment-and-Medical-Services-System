  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        room: res?.appointment?.room_name || res?.room_name || "Chưa xác định",
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        room: res?.appointment?.room_name || res?.room_name || "Online",
        doctorOrStaff: selectedDoctor.name,
        date: selectedDate,
        time: selectedTime.time_slot || selectedTime.time,
        fee: getConsultPrice(),
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const mappedData = {
        ...
        room: res?.appointment?.room_name || res?.room_name || "Phòng xét nghiệm",
