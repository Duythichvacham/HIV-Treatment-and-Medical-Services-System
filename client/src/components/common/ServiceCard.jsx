...
const ServiceCard = ({ iconBg = 'bg-green-600', iconColor = 'text-white', icon, title, subtitle, duration, price, features = [], link }) => (
  <div className="bg-white rounded-xl p-8 shadow border border-green-100 flex flex-col justify-between">
    <div>
      <div className="flex items-center mb-2">
        ...
        <div>
          <h3 className="font-bold text-lg text-green-700">{title}</h3>
