...
export const arvRegimenManagerApi = {
  ...
  create: async (regimenData) => {
    try {
      const response = await api.post(`${import.meta.env.VITE_API_PREFIX}/arv-regimens/`, regimenData);
  ...
  update: async (regimenId, regimenData) => {
    try {
      const response = await api.patch(
        `${import.meta.env.VITE_API_PREFIX}/arv-regimens/update/${regimenId}/`,
        regimenData
      );
  ...
  setActive: async (regimenId, isActive) => {
    try {
      const response = await api.patch(
        `${import.meta.env.VITE_API_PREFIX}/arv-regimens/active/${regimenId}/`,
        {
          is_active: isActive,
        }
      );
