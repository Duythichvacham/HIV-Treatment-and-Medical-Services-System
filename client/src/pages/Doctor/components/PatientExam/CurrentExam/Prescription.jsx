        ...
        {treatmentOption === "continue" ? (
          <div className="p-3 bg-gray-50 rounded border border-gray-200">
            <p className="text-gray-700">
              {currentARVRegimen?.regimen_name
                ? `Tiếp tục phác đồ ${currentARVRegimen.regimen_name}`
                : "Chưa có phác đồ hiện tại"}
            </p>
          </div>
        ) : (
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
            ...
            <form
              onSubmit={(e) => {
                ...
                const frequencyNumber = formData.get("frequency_number") || "1";
                const drugData = {
                  drug_name: formData.get("drug_name"),
                  dosage: formData.get("dosage"),
                  frequency: `${frequencyNumber} lần/ngày`,
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <select
                      ...
                      className="w-20 px-3 py-2 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      defaultValue="1"
                    >
