          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="bg-green-50 p-6 rounded-2xl text-center shadow border-2 border-green-100">
                ...
                <div className="text-lg text-gray-600 mt-2">Chi phí</div>
              </div>
              <div className="bg-green-50 p-6 rounded-2xl text-center shadow border-2 border-green-100">
                <div className="text-3xl font-bold text-green-700">
                  {service.service_type === "test" ? "Xét nghiệm" : "Tư vấn"}
                </div>
                <div className="text-lg text-gray-600 mt-2">Loại dịch vụ</div>
              </div>
            </div>
          </div>
        </section>
              ...
              <ul className="space-y-4">
                {service.details.map((detail, index) => (
                  <li key={index} className="flex items-start text-lg">
                    <span className="text-green-600 mr-4 mt-1 text-xl">✓</span>
              ...
              <div className="space-y-6">
                {service.process.map((step, index) => (
                  <div key={index} className="flex items-start text-lg">
                    <div className="bg-green-600 text-white rounded-full w-10 h-10 flex items-center justify-center text-xl font-bold mr-6 mt-1">
                      {index + 1}
                    </div>
                    <div className="text-gray-700 flex-1">{step}</div>
                  </div>
                ))}
              </div>
            </div>
