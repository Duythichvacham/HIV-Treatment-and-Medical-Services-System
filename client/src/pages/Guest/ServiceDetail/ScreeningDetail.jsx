    ...
    <div className="px-4 py-8 max-w-7xl mx-auto">
      ...
      <section className="bg-green-50 p-6 rounded-lg mb-8 flex flex-col md:flex-row items-center">
        ...
        <div className="mt-4 md:mt-0 md:ml-4 flex-1">
          <h1 className="text-3xl font-bold text-green-700">Xét nghiệm sàng lọc HIV</h1>
          <p className="text-gray-600 mt-1">Sàng lọc HIV từ giai đoạn sớm (giai đoạn phơi nhiễm sau 18 ngày)</p>
          <div className="mt-3 flex items-center space-x-6">
            <div className="flex items-center text-gray-600">
              ...
              <span className="ml-1 font-medium">30 phút</span>
            </div>
            <div className="text-blue-600 font-semibold text-lg">169.000đ</div>
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <AppointmentForm
            ...
            serviceName="Xét nghiệm sàng lọc HIV"
            duration="30 phút"
            price="169.000đ"
            user={user}
          />
