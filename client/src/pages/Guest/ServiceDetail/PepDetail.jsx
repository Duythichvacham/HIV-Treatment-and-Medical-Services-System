    ...
    <div className="px-4 py-8 max-w-7xl mx-auto">
      ...
      <section className="bg-red-50 p-6 rounded-lg mb-8 flex flex-col md:flex-row items-center">
        ...
        <div className="mt-4 md:mt-0 md:ml-4 flex-1">
          <h1 className="text-3xl font-bold text-red-600">PEP - Dự phòng sau phơi nhiễm HIV</h1>
          <p className="text-gray-600 mt-1">PEP (Post-Exposure Prophylaxis) là biện pháp dự phòng HIV sau khi tiếp xúc với nguy cơ phơi nhiễm trong 72 giờ đầu.</p>
          <div className="mt-3 flex items-center space-x-6">
            <div className="flex items-center text-gray-600">
              ...
              <span className="ml-1 font-medium">28 ngày</span>
            </div>
            <div className="text-blue-600 font-semibold text-lg">Miễn phí</div>
          </div>
        </div>
      </section>
