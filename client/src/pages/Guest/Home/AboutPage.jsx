        ...
        <section className="relative bg-green-700 text-white py-20 shadow-xl overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4 animate-fade-in-up">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg">
              Giới thiệu về HIV Care Center
            </h1>
            <p className="text-lg md:text-xl font-medium mb-6 drop-shadow">
              Trung tâm tiên phong trong chăm sóc, xét nghiệm và điều trị
              HIV/AIDS tại Việt Nam
            </p>
            <Link
              to="/"
              className="inline-block bg-white text-green-700 font-bold px-8 py-3 rounded-full shadow hover:bg-green-100 transition"
            >
              Về trang chủ
            </Link>
          </div>
        ...
        <section className="max-w-5xl mx-auto py-16 px-4 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 animate-fade-in-right">
            ...
            <p className="text-gray-700">
              Được thành lập từ năm 2010, HIV Care Center là đơn vị tiên phong
              trong lĩnh vực phòng chống, xét nghiệm và điều trị HIV/AIDS tại
              Việt Nam. Chúng tôi cam kết mang lại dịch vụ y tế chất lượng cao,
              bảo mật và không kỳ thị cho mọi bệnh nhân.
            </p>
            <ul className="list-disc pl-6 text-gray-600">
              <li>
                Sứ mệnh: Chăm sóc toàn diện, đồng hành cùng bệnh nhân HIV/AIDS.
              </li>
              <li>
                Tầm nhìn: Trở thành trung tâm hàng đầu khu vực về điều trị
                HIV/AIDS.
              </li>
              ...
              <div className="grid md:grid-cols-4 lg:grid-cols-5 gap-6">
                {doctors && doctors.length > 0 ? (
                  doctors.map((doctor, idx) => (
                    <div
                      key={doctor.doctor_id || doctor.id || idx}
                      className="bg-white rounded-2xl shadow-lg p-6 text-center hover:scale-105 transition-all duration-300 animate-fade-in-up border border-gray-100"
                    >
                      ...
                      <h3 className="font-bold text-lg text-green-800 mb-1 leading-tight">
                        {doctor.name ||
                          `BS. ${doctor.full_name || "Chuyên gia"}`}
                      </h3>
                    </div>
                  ))
                ) : (
          ...
          <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-6 animate-fade-in-left">
              ...
              <ul className="list-disc pl-6 text-gray-700">
                ...
                <li>
                  Đối tác với các tổ chức y tế lớn: WHO, UNAIDS, Bộ Y tế Việt
                  Nam.
                </li>
                <li>
                  Tham gia nhiều dự án cộng đồng, nâng cao nhận thức về
                  HIV/AIDS.
                </li>
        ...
        <section className="bg-green-50 py-16">
          <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-6 animate-fade-in-right">
              ...
              <p className="text-gray-700">
                Trung tâm được trang bị hệ thống phòng khám, phòng xét nghiệm và
                điều trị hiện đại, đạt chuẩn quốc tế. Không gian thân thiện,
                sạch sẽ, tạo cảm giác an tâm cho bệnh nhân.
              </p>
              <ul className="list-disc pl-6 text-gray-600">
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 text-center animate-fade-in-up">
            ...
            <p className="text-lg text-gray-700 mb-4">
              Chúng tôi cam kết mang lại dịch vụ y tế chất lượng cao, bảo mật
              tuyệt đối thông tin bệnh nhân, không kỳ thị và luôn đồng hành cùng
              bạn trên hành trình chiến thắng HIV/AIDS.
            </p>
